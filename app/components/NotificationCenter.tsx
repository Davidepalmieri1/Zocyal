...
export default function NotificationCenter() {
  ...
  useEffect(() => {
    window.dispatchEvent(new CustomEvent("zocyal:notification-count",{detail:{count:notices.length}}))
  },[notices.length])
