...
export default function RewardsAdminPage() {
  ...
  async function useTemplate(id:string){setBusy(true);setError("");try{await mutate({action:"create_from_template",template_id:id,event_code:code});await load()}catch(e){setError(e instanceof Error?e.message:"Errore inatteso.")}finally{setBusy(false)}}
